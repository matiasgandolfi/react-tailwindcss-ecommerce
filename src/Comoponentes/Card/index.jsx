...
const Card = ({data}) => {
    ...
    const showProduct = (infoProducto) => {
        context.openProductDetail();
        context.setProductToShow(infoProducto);
    }

    const addProductsToCart = (infoProducto) => {
        context.setCartProducts([...context.cartProducts, infoProducto]);
